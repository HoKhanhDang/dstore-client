...
const Auth = () => {
    ...
    return (
        <>
            <button
                className="h-fit p-2 rounded-secondary hover:bg-slate-100 transition-colors"
                    ...
                    {Object.keys(user).length === 0 ? (
                        ...
                        <div className="flex flex-col gap-y-2">
                            <div
                                onClick={() =>
                                    navigate(
                                        `dashboard/${user.role}/my-profile`
                                    )
                                }
                                className="flex flex-row gap-x-2 p-4"
                            >
                                <Image
                                    src={user?.avatar?.url}
