                            ...
                            <p className="text-sm flex flex-col gap-y-2">
                                ...
                                <p className="flex flex-col gap-y-1.5">
                                    <span className="flex flex-row gap-x-1 items-center text-xs">
                                        <Inform /> {user?.cart?.length} products
                                        from cart
                                    </span>
                                    <span className="flex flex-row gap-x-1 items-center text-xs">
                                        <Inform /> {user?.favorites?.length}{" "}
                                        products from favorites
                                    </span>
                                    <span className="flex flex-row gap-x-1 items-center text-xs">
                                        <Inform /> {user?.purchases?.length}{" "}
                                        purchases records
                                    </span>
                                    <span className="flex flex-row gap-x-1 items-center text-xs">
                                        <Inform /> {user?.products?.length}{" "}
                                        products all time records
                                    </span>
                                </p>
                            </p>
                        </div>
