...
const Page = () => {
    ...
    const [productThumbnailPreview, setProductThumbnailPreview] =
        useState(null);
    ...
    useEffect(() => {
        ...
        if (fetchProductData) {
            toast.success(fetchProductData?.description, {
                id: "fetchProduct",
            });
        }

        if (fetchProductError) {
            toast.error(fetchProductError?.data?.description, {
                id: "fetchProduct",
            });
        }
        ...
        if (updateProductData) {
            toast.success(updateProductData?.description, {
                id: "updateProduct",
            });
        }
        ...
        if (fetchBrandsError) {
            toast.error(fetchBrandsError?.data?.description, {
                id: "fetchBrands",
            });
        }
                ...
                <div className="w-full flex flex-row gap-x-4">
                    ...
                    <div className="w-fit flex flex-col gap-y-4 p-4 border rounded">
                        {productThumbnailPreview && (
                            <Image
                                src={
                                    productThumbnailPreview?.url ||
                                    productThumbnailPreview
                                }
                                alt={
                                    productThumbnailPreview?.public_id ||
                                    "thumbnail"
                                }
                                width={96}
                                height={96}
